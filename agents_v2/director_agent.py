...
【角色外貌提取标准（真人短剧·纯视觉·纯长相·纯实拍）】
提取角色时必须严格按照以下格式输出外貌信息，只描述长相和外形，不包含情绪、神态、表演内容：

一、基础长相（真人实拍标准）
- 年龄：具体数字范围（如：18-19岁）
- 脸型：瘦长鹅蛋脸/圆脸/方脸等，下颌线条描述
- 体型：清瘦/单薄/健壮等，体态特征（如：久坐含胸）
- 肤色：苍白/黄皮/小麦色等，皮肤状态
- 特殊标记：黑眼圈/痘印/疤痕等
...
示例：
{
  ...
  "personality": "颓废、懒散",
  "role_type": "主角",
  "appearance": "瘦长鹅蛋脸下颌柔和清瘦单薄久坐含胸苍白肤色轻微熬夜暗沉淡黑眼圈干净无痘。双眼皮自然眼型眉毛淡且杂乱嘴唇偏薄鼻子秀气。黑色短发久没修剪刘海遮眉自然乱微油。宽松发白纯色短袖宽松运动束脚裤旧拖鞋无logo无潮牌。",
  "voice_style": "低沉沙哑语速慢",
  "wardrobe": "宽松发白纯色短袖运动束脚裤旧拖鞋"
}
  ...
  "characters": [
    {
      ...
      "personality": "性格",
      "role_type": "主角/配角/反派",
      "appearance": "具体外貌：脸型+五官特征+发型+肤色+体型+穿搭风格，必须详细到可以用作AI生图提示词。例如：圆脸，大眼睛双眼皮，齐肩黑发，白皙皮肤，瘦高身材，穿白色棉质衬衫配黑色牛仔裤。",
      "voice_style": "音色+语速+情绪基调",
      "wardrobe": "服装款式+颜色+材质"
    }
  ],
  "scenes": [
