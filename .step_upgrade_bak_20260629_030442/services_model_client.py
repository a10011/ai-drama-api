...
def generate_video(
    ...
    **kwargs
    ...
    try:
        ...
        retry_count = 0
        max_same_model_retries = 2  # 同模型重试2次，不跨模型降级
...
def generate_image_to_image(
    ...
    if reference_image and reference_image.startswith('http') and 'ai.mzsh.top' not in reference_image:
        try:
            ...
            with open(local_path, "wb") as f:
                f.write(img_data)
            reference_image = f"https://ai.mzsh.top/storage/figures/i2i_ref_{h}.jpg"
